...
// ============================================================
// CommentsPage — сторінка коментарів
// Коментарі зберігаються локально у стані компонента.
// (Розділ доступний для всіх користувачів)
// ============================================================
function CommentsPage() {
  ...
  function handleSubmit() {
    ...
    setComments(prev => [{ id: Date.now(), name, email, lesson, comment }, ...prev]);
        ...
        <div className="comments-layout">
          ...
          <div className="comment-form">
            ...
            <div className="form-group">
              ...
              />
              {errors.name && (
                <div className="field-error show">Будь ласка, введіть ім'я</div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.email && (
                <div className="field-error show">Введіть коректний email</div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.comment && (
                <div className="field-error show">Коментар не може бути порожнім</div>
              )}
            </div>
          ...
          {/* Список коментарів */}
          <div>
            <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.4rem', marginBottom: '1.5rem' }}>
              Коментарі студентів
            </h3>
            {comments.length === 0 ? (
              ...
              comments.map(c => (
                <div key={c.id} className="comment-item">
                  ...
                  {c.lesson && (
                    <div className="comment-lesson">Урок: {c.lesson}</div>
                  )}
